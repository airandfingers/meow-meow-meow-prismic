...
/** Content for MEow documents */
type MeowDocumentData = Record<string, never>;
/**
 * MEow document from Prismic
 *
 * - **API ID**: `meow`
 * - **Repeatable**: `true`
 * - **Documentation**: https://prismic.io/docs/core-concepts/custom-types
 ...
 * @typeParam Lang - Language API ID of the document.
 */
export type MeowDocument<Lang extends string = string> = prismicT.PrismicDocumentWithoutUID<Simplify<MeowDocumentData>, "meow", Lang>;
...
export type AllDocumentTypes = ArticleDocument | MeowDocument | NavigationDocument | PageDocument | SettingsDocument;
/**
...
export interface ImageSliceDefaultItem {
    /**
     * text field in *Image → Items*
     *
     * - **Field Type**: Text
     * - **Placeholder**: *None*
     * - **API ID Path**: image.items[].text
